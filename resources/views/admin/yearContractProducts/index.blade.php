...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-YearContractProduct">
            <thead>
                <tr>
                    <th width="10">
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.year-contract-products.index') }}",
    columns: [
      { data: 'placeholder', name: 'placeholder' },
{ data: 'id', name: 'id' },
{ data: 'year_contractid_start_date', name: 'year_contractid.start_date' },
{ data: 'year_contractid.end_date', name: 'year_contractid.end_date' },
{ data: 'year_contractid.status', name: 'year_contractid.status' },
{ data: 'productid_name', name: 'productid.name' },
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-YearContractProduct').DataTable(dtOverrideGlobals);
