                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route("frontend.user-infos.store") }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" name="bank_account_number" id="bank_account_number" value="{{ old('bank_account_number', '') }}" step="1" required>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="tax_code" id="tax_code" value="{{ old('tax_code', '') }}">
